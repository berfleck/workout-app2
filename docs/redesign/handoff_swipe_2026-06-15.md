...
> **Nota (2026-06-16):** este arquivo é o **prompt de abertura** daquela sessão —
> não acumula estado da iniciativa. O progresso e o estado final dos Sub-PRs 1-8
> (incl. os 6/7/8 que rodaram depois deste prompt) vivem no doc-base:
> **`guia_swipe_edicao_direta.md` §9 + §13 "Estado final"**. As seções de
> conclusão que antes ficavam aqui foram consolidadas lá.
